...
public class BibArticle extends BibRecordWithPublisher {
  ...
  public BibArticle(final BibAuthors authors, final String title,
      ...
      final String endPage, final BibOrganization publisher, final URI uri,
      final String doi) {
  ...
  final boolean _equals(final BibRecord r) {
    ...
    if (super._equals(r)) {
      ...
      return (Compare.equals(this.m_journal, x.m_journal) && //
          Compare.equals(this.m_issn, x.m_issn) && //
          Compare.equals(this.m_volume, x.m_volume) && //
          Compare.equals(this.m_number, x.m_number) && //
          Compare.equals(this.m_startPage, x.m_startPage) && //
          Compare.equals(this.m_endPage, x.m_endPage));
    }
  ...
  final int _compareRest(final BibRecord o) {
    ...
    if (o instanceof BibArticle) {
      ...
      r = Compare.compare(this.m_journal, bb.m_journal);
      if (r != 0) {
        return r;
      }

      r = Compare.compare(this.m_issn, bb.m_issn);
      if (r != 0) {
        return r;
      }

      r = Compare.compare(this.m_volume, bb.m_volume);
      if (r != 0) {
        return r;
      }

      r = Compare.compare(this.m_number, bb.m_number);
      if (r != 0) {
        return r;
      }

      r = Compare.compare(this.m_startPage, bb.m_startPage);
      if (r != 0) {
        return r;
      }

      r = Compare.compare(this.m_endPage, bb.m_endPage);
      if (r != 0) {
        return r;
      }
    }
