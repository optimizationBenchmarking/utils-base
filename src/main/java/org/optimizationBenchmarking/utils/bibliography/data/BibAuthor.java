...
public class BibAuthor extends _BibElement<BibAuthor>
  ...
  public BibAuthor(final String personalName, final String familyName,
    ...
    this(false, TextUtils.normalize(personalName),
        TextUtils.normalize(familyName),
        TextUtils.normalize(originalSpelling));
  }
  ...
  public final boolean equals(final Object o) {
    ...
    if (o instanceof BibAuthor) {
      b = ((BibAuthor) o);
      return (Compare.equals(this.m_familyName, b.m_familyName) && //
          Compare.equals(this.m_personalName, b.m_personalName) && //
          Compare.equals(this.m_originalSpelling, b.m_originalSpelling));
    }
    return false;
  }
  ...
  public final int compareTo(final BibAuthor o) {
    ...
    i = Compare.compare(this.m_familyName, o.m_familyName);
    if (i != 0) {
      return i;
    }

    i = Compare.compare(this.m_personalName, o.m_personalName);
    if (i != 0) {
      return i;
    }

    return Compare.compare(this.m_originalSpelling, o.m_originalSpelling);
  }
