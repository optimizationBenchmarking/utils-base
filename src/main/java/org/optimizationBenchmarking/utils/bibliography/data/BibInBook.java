...
public class BibInBook extends BibRecord {
  ...
  BibInBook(final boolean direct, final BibAuthors authors,
      final String title, final BibBookRecord book, final String startPage,
  ...
  final int _compareRest(final BibRecord o) {
    ...
    if (o instanceof BibInBook) {
      ...
      r = Compare.compare(this.m_book, bb.m_book);
      if (r != 0) {
        return r;
      }
      ...
      r = Compare.compare(this.m_chapter, bb.m_chapter);
      if (r != 0) {
        return r;
      }
    }
