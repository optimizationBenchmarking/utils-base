...
public class BibOrganization extends _BibElement<BibOrganization> {
  ...
  BibOrganization(final boolean direct, final String name,
    ...
    this.m_originalSpelling = (direct ? originalSpelling
  ...
  public boolean equals(final Object r) {
    ...
    if (r instanceof BibOrganization) {
      ...
      return (Compare.equals(this.m_name, x.m_name) && //
          Compare.equals(this.m_address, x.m_address));
  ...
  public final int compareTo(final BibOrganization o) {
    ...
    r = Compare.compare(this.m_name, o.m_name);
    if (r != 0) {
      return r;
    }
    r = Compare.compare(this.m_address, o.m_address);
    if (r != 0) {
      return r;
    }
