...
public abstract class BibRecord extends _BibElement<BibRecord>
  ...
  boolean _equals(final BibRecord r) {
    return (Compare.equals(this.m_authors, r.m_authors) && //
        Compare.equals(this.m_title, r.m_title) && //
        Compare.equals(this.m_date, r.m_date) && //
        Compare.equals(this.m_url, r.m_url) && //
        Compare.equals(this.m_doi, r.m_doi));
  }
  ...
  public final int compareTo(final BibRecord o) {
    ...
    r = Compare.compare(this.m_date, o.m_date);
    if (r != 0) {
      return r;
    }

    r = Compare.compare(this.m_authors, o.m_authors);
    if (r != 0) {
      return r;
    }

    r = Compare.compare(this.m_title, o.m_title);
    if (r != 0) {
      return r;
    }
  ...
  int _compareRest(final BibRecord o) {
    int r;
    r = Compare.compare(this.m_url, o.m_url);
    if (r != 0) {
      return r;
    }
    return Compare.compare(this.m_doi, o.m_doi);
  }
