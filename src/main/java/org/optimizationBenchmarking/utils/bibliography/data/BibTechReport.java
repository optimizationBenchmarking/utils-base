...
public class BibTechReport extends BibRecordWithPublisher {
  ...
  public BibTechReport(final BibAuthors authors, final String title,
      ...
      final String doi) {
    this(false, authors, title, date, series, number, issn, publisher, uri,
        doi);
  }
  ...
  final boolean _equals(final BibRecord r) {
    ...
    if (super._equals(r)) {
      ...
      return (Compare.equals(this.m_issn, x.m_issn) && //
          Compare.equals(this.m_series, x.m_series) && //
  ...
  final int _compareRest(final BibRecord o) {
    ...
    if (o instanceof BibTechReport) {
      ...
      r = Compare.compare(this.m_series, bb.m_series);
      if (r != 0) {
        return r;
      }
