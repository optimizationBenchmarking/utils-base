...
public class BibThesis extends BibBook {
  ...
  final boolean _equals(final BibRecord r) {
    ...
    if (super._equals(r)) {
      ...
      return (Compare.equals(this.m_type, x.m_type) && //
          Compare.equals(this.m_school, x.m_school));
    }
  ...
  final int _compareRest(final BibRecord o) {
    ...
    if (o instanceof BibThesis) {
      ...
      r = Compare.compare(this.m_type, bb.m_type);
      if (r != 0) {
        return r;
      }

      r = Compare.compare(this.m_school, bb.m_school);
      if (r != 0) {
        return r;
      }
