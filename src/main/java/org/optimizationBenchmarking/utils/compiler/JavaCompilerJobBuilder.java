 ...
 */
public final class JavaCompilerJobBuilder
    extends ToolJobBuilder<JavaCompilerJob, JavaCompilerJobBuilder> {
  ...
  public final JavaCompilerJobBuilder addClass(final String name,
    ...
    synchronized (this.m_files) {
      if (!(this.m_files.containsKey(name))) {
        this.m_files.put(name,
            new _CharSequenceJavaFileObject(useName, useBody));
        return this;
      }
    }
