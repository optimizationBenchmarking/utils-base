...
public class PageDimension extends PhysicalDimension {
  ...
  public PageDimension(final double width, final double height,
      final int columnCount, final double columnWidth,
      final ELength unit) {
  ...
  public PageDimension convertTo(final ELength unit) {
    ...
    return new PageDimension(//
        u.convertToAsDouble(this.getWidth(), unit), //
        u.convertToAsDouble(this.getHeight(), unit), //
        this.m_columnCount, //
        u.convertToAsDouble(this.m_columnWidth, unit), //
        unit);
  }
  ...
  public boolean equals(final Object o) {
    ...
    if (o instanceof PageDimension) {
      ...
      return ((this.m_columnCount == dim.m_columnCount)//
          && (Compare.equals(this.m_width, dim.m_width))//
          && (Compare.equals(this.m_height, dim.m_height))//
          && (Compare.equals(this.m_columnWidth, dim.m_columnWidth))//
