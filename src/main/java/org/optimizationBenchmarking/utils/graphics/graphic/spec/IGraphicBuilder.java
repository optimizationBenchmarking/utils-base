...
public interface IGraphicBuilder extends IDocumentProducerJobBuilder {
   ...
   * </p>
   * <p>
   * Not all graphics may support this property.
   * <a href="http://en.wikipedia.org/wiki/Raster_graphics">Raster
   * graphics</a>, such as PNGs or JPGs should support it. For
   * <a href="http://en.wikipedia.org/wiki/Vector_graphics">vector
   * graphic</a> formats such as EPS or PDF, it makes no much sense. These
   * formats may still support this property, though, maybe to deal with
   * raster graphics inserted into them, via, e.g.,
   ...
   * </p>
   * <p>
   * If this parameter is not set, a reasonable default is used.
   * </p>
   *
   * @param dotsPerInch
  ...
  /**
   * <p>
   * Set the {@link org.optimizationBenchmarking.utils.graphics.EColorModel
   ...
   * stream. Some graphics formats, such as GIF may support only very
   * limited color models (in that case, only 256 colors). You may set the
   * color model here to
   * {@link org.optimizationBenchmarking.utils.graphics.EColorModel#RGB_24_BIT
