 ...
 */
public abstract class BasicNumber extends Number
    implements Comparable<Number>, ITextable {
   ...
   * @see #getState()
   */
  public static final int STATE_POSITIVE_OVERFLOW = (BasicNumber.STATE_DOUBLE
      + 1);
  /**
   ...
   * @see #getState()
   */
  public static final int STATE_POSITIVE_INFINITY = (BasicNumber.STATE_POSITIVE_OVERFLOW
      + 1);
   ...
   * @see #getState()
   */
  public static final int STATE_NEGATIVE_OVERFLOW = (BasicNumber.STATE_POSITIVE_INFINITY
      + 1);
  /**
   ...
   * @see #getState()
   */
  public static final int STATE_NEGATIVE_INFINITY = (BasicNumber.STATE_NEGATIVE_OVERFLOW
      + 1);
  /**
   ...
   * @see #getState()
   */
  public static final int STATE_NAN = (BasicNumber.STATE_NEGATIVE_INFINITY
      + 1);

  /** the state names */
  static final String[] STATE_NAMES = { "empty", //$NON-NLS-1$
      null, null, "overflow", //$NON-NLS-1$
      Double.toString(Double.POSITIVE_INFINITY), "underflow", //$NON-NLS-1$
  ...
  public boolean isReal() {
    final int state;
    state = this.getState();
    return ((state == BasicNumber.STATE_INTEGER)
        || (state == BasicNumber.STATE_DOUBLE));
  }
