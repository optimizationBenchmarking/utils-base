...
public class LooseStringParser extends StringParser {

  /** the serial version uid */
  private static final long serialVersionUID = 1L;
  /** the globally shared instance of the boolean parser */
  public static final LooseStringParser INSTANCE = new LooseStringParser();

  /** create the parser */
  protected LooseStringParser() {
    super();
  }
  ...
  private final Object writeReplace() {
    return LooseStringParser.INSTANCE;
  }
