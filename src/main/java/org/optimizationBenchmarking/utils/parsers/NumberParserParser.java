...
public final class NumberParserParser
    extends InstanceParser<NumberParser<Number>> {
  ...
  static {
    ...
    ReflectionUtils.addPackageOfClassToPrefixList(NumberParserParser.class,
        paths);
  ...
  private final NumberParser<Number> __parse(final String parserClass,
    ...
    try {
      return clazz.getConstructor(Number.class, Number.class)
          .newInstance(lower, upper);
