...
public final class Braces extends _Enclosure<Brace> {
  ...
  static {
    ...
    data = new Braces[] { Braces.PARENTHESES, Braces.BRACKETS,
        Braces.CURLY_BRACES, Braces.ANGLE, Braces.PIPE, Braces.DOUBLE_PIPE,
        Braces.VERTICAL, Braces.BRACKETS_WITH_DASH,
        Braces.RAISED_PARENTHESES, Braces.SUNK_PARENTHESES, Braces.CHEVRON,
        Braces.DOUBLE_ANGLE, Braces.TRIPLE_ANGLE, Braces.CEILING,
        Braces.FLOOR, Braces.CHINESE_BLACK_PARENTHESES,
