...
public final class Characters extends ArraySetView<Char> {
  ...
  /** vertical b */
  public static final Brace BRACE_VERTICAL_CLOSE = new Brace(0x2040, false,
      true);
  ...
  /** sunk parentheses a */
  public static final Brace BRACE_SUNK_PARENTHESES_OPEN = new Brace(0x208d,
      true, false);
  /** sunk parentheses b */
  ...
  static {
    ...
    data = new Char[] { Characters.CONTROL_NULL,
        ...
        Characters.CONTROL_END_OF_TRANSMISSION, Characters.CONTROL_ENQUIRY,
        Characters.CONTROL_ACKNOWLEDGE, Characters.CONTROL_BELL,
        Characters.CONTROL_BACKSPACE, Characters.CONTROL_HORIZONTAL_TAB,
        Characters.CONTROL_LINE_FEED, Characters.CONTROL_VERTICAL_TAB,
        Characters.CONTROL_FORM_FEED, Characters.CONTROL_CARRIAGE_RETURN,
        Characters.CONTROL_SHIFT_OUT, Characters.CONTROL_SHIFT_IN,
        Characters.CONTROL_DATA_LINK_ESCAPE,
        ...
        Characters.QUOTE_ALT_SINGLE_OPEN, Characters.QUOTE_ALT_DOUBLE_OPEN,
        ...
        Characters.BRACE_TRIPLE_ANGLE_CLOSE, Characters.BRACE_CEILING_OPEN,
        Characters.BRACE_CEILING_CLOSE, Characters.BRACE_FLOOR_OPEN,
        Characters.BRACE_FLOOR_CLOSE, Characters.QUOTE_DINGBAT_SINGLE_OPEN,
