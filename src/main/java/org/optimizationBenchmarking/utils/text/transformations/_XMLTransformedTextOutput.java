...
class _XMLTransformedTextOutput extends _TransformedTextOutput {
  ...
  private static final int MODE_IGNORE = (_XMLTransformedTextOutput.MODE_PASS_THROUGH
      + 1);

  /** transform the character into a space */
  private static final int MODE_TO_SPACE = (_XMLTransformedTextOutput.MODE_IGNORE
      + 1);

  /** transform the character */
  private static final int MODE_TRANSFORM = (_XMLTransformedTextOutput.MODE_TO_SPACE
      + 1);
