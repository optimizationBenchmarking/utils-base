 ...
 */
public interface IDocumentProducerJobBuilder
    extends IFileProducerJobBuilder, IConfigurableToolJobBuilder {
  ...
  /** {@inheritDoc} */
  @Override
  public abstract IDocumentProducerJobBuilder setLogger(
      final Logger logger);
