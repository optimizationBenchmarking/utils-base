...
public enum ELength implements IUnit {
  ...
  /**
   * <a href="http://en.wikipedia.org/wiki/Angstrom">&aring;ngstr&ouml;m
   * </a>
   */
  ...
  /**
   * <a href= "http://en.wikipedia.org/wiki/Point_%28typography%29">point
   * </a> according to
   * <a href="http://en.wikipedia.org/wiki/PostScript">PostScript</a>
   * definition
   */
  ...
  static {
    ...
    comp.setFactor(ELength.CUBIT, ELength.FOOT,
        Rational.valueOf(15L, 10L));
    comp.setFactor(ELength.ELL, ELength.FOOT,
        Rational.valueOf(375L, 100L));
    ...
    comp.setFactor(ELength.LIGHT_SECOND, ELength.MICROMETER,
        299792458000000L);
    comp.setFactor(ELength.LIGHT_SECOND, ELength.MILLIMETER,
        299792458000L);
    ...
    comp.setFactor(ELength.ASTRONOMICAL_UNIT, ELength.DECIMETER,
        1495978707000L);
    comp.setFactor(ELength.ASTRONOMICAL_UNIT, ELength.METER,
        149597870700L);
  ...
  /**
   * create the exception if the other length unit is {@code null}.
   *
   * @return the exception to throw
   */
  private static final IllegalArgumentException __null() {
    return new IllegalArgumentException(
        "Other length unit cannot be null."); //$NON-NLS-1$
  }

  /**
   * Create the exception if the other length unit is of an invalid type
   *
   * @param other
   *          the unit
   * @return the exception to throw
   */
  private static final IllegalArgumentException __type(final IUnit other) {
    if (other == null) {
      return ELength.__null();
    }
    return new IllegalArgumentException(//
        "Other unit must be instance of ELength, but is " //$NON-NLS-1$
            + other + " of type " + //$NON-NLS-1$
            other.getClass());
  }
   ...
   * @return the function
   */
  public final UnaryFunction getConversionFunction(final ELength other) {
    if (other != null) {
      return ELength.CONVERT[this.ordinal()][other.ordinal()];
    }
    throw ELength.__null();
  }

  /** {@inheritDoc} */
  @Override
  public final UnaryFunction getConversionFunction(final IUnit other) {
    if (other instanceof ELength) {
      return ELength.CONVERT[this.ordinal()][((ELength) other).ordinal()];
    }
    throw ELength.__type(other);
  }
   ...
   * @return the result
   */
  public final double convertToAsDouble(final long value,
      final ELength other) {
    UnaryFunction f;
  ...
  public final double convertToAsDouble(final long value,
      final IUnit other) {
    if (other instanceof ELength) {
      return this.convertToAsDouble(value, ((ELength) other));
    }
    throw ELength.__type(other);
  }
   ...
   * @return the result
   */
  public final double convertToAsDouble(final double value,
      final ELength other) {
    UnaryFunction f;
   ...
   * @return the result
   */
  public final long convertToAsLong(final long value,
      final ELength other) {
    UnaryFunction f;
  ...
  /** {@inheritDoc} */
  @Override
  public final long convertToAsLong(final long value, final IUnit other) {
    if (other instanceof ELength) {
      return this.convertToAsLong(value, ((ELength) other));
    }
    throw ELength.__type(other);
  }
