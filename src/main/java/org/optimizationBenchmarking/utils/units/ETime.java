...
public enum ETime implements IUnit {
  ...
  /**
   * create the exception if the other time unit is {@code null}.
   *
   * @return the exception to throw
   */
  private static final IllegalArgumentException __null() {
    return new IllegalArgumentException("Other time unit cannot be null."); //$NON-NLS-1$
  }

  /**
   * Create the exception if the other time unit is of an invalid type
   *
   * @param other
   *          the unit
   * @return the exception to throw
  ...
  private static final IllegalArgumentException __type(final IUnit other) {
    ...
    return new IllegalArgumentException(//
        "Other unit must be instance of ETime, but is " //$NON-NLS-1$
   ...
   * @return the function
   */
  public final UnaryFunction getConversionFunction(final ETime other) {
    if (other != null) {
  ...
  public final double convertToAsDouble(final long value,
      final IUnit other) {
    if (other instanceof ETime) {
      return this.convertToAsDouble(value, ((ETime) other));
    }
    throw ETime.__type(other);
  }
   ...
   * @return the result
   */
  public final long convertToAsLong(final long value, final ETime other) {
    UnaryFunction f;
  ...
  public final long convertToAsLong(final long value, final IUnit other) {
    if (other instanceof ETime) {
      return this.convertToAsLong(value, ((ETime) other));
    }
    throw ETime.__type(other);
  }
