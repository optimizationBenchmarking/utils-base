...
public final class CharEncodingComparison {
  ...
  private static final String __encode(final int chr,
  ...
  /**
   * Compute the <a href="http://www.unicode.org/reports/tr15/">NFKC</a>
   * -normalization of the character {@code chr}
   *
   * @param chr
   *          the character
  ...
  /**
   * Compute the
   * <a href="http://en.wikipedia.org/wiki/Query_string#URL_encoding" >URL-
   * encoding</a> of the character {@code chr}, based on UTF-8
   *
   * @param chr
   *          the character
  ...
  public static final void main(final String[] args) {
    ...
    try (final FileWriter fw = new FileWriter(
      ...
      try (final BufferedWriter bw = new BufferedWriter(fw)) {
        ...
        bw.write(
            "<table border=\"1\" style=\"border-collapse:collapse;text-align:right;font-family:monospace\">"); //$NON-NLS-1$
  ...
  private static final void __head1(final Writer bw) throws IOException {
    ...
    bw.write(
        "<th><a href=\"http://www.unicode.org/reports/tr15/\">NFKC</a></th>"); //$NON-NLS-1$
    bw.write(
        "<th><a href=\"http://en.wikipedia.org/wiki/Unicode\">Code Point</a></th>"); //$NON-NLS-1$
    bw.write("<th>Decimal</th>"); //$NON-NLS-1$
    bw.write(
        "<th><a href=\"http://en.wikipedia.org/wiki/Query_string#URL_encoding\">in URL</a></th>"); //$NON-NLS-1$
  ...
  private static final void __head2(final Writer bw) throws IOException {
    ...
    bw.write(
        "\">Encoding: hexadecimal, bytes in same order as they appear in a file, ");//$NON-NLS-1$
