...
public final class ExternalProcessTest {
  ...
  public static final void main(final String[] args) throws IOException {
    ...
    // echo
    program = PathUtils.findFirstInPath(
        new AndPredicate<>(new FileNamePredicate(true, "echo"), //$NON-NLS-1$
    ...
    // latex
    program = PathUtils.findFirstInPath(
        new AndPredicate<>(new FileNamePredicate(true, "pdftex", "latex"), //$NON-NLS-1$//$NON-NLS-2$
            CanExecutePredicate.INSTANCE), //
        IsFilePredicate.INSTANCE, null);//
    ...
    // java
    program = PathUtils.findFirstInPath(
        new AndPredicate<>(new FileNamePredicate(true, "java"), //$NON-NLS-1$
            CanExecutePredicate.INSTANCE), //
        IsFilePredicate.INSTANCE, null);//
