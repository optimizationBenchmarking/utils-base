...
public final class FontLoadingTest {
  ...
  public static final void main(final String[] args) {
    Font font;
    try (final InputStream is = ReflectionUtils.getResourceAsStream(
        "org.optimizationBenchmarking.utils.document.impl.latex.documentClasses.IEEEtranFontPalette#nimbusMonoLBold.pfb")) { //$NON-NLS-1$
