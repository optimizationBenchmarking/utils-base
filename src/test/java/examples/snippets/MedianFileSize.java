...
/**
 * A simple tool to get the median file size from logs created with
 * <a href="http://www.logisticPlanning.org/tsp/">TSPSuite</a>.
 */
public final class MedianFileSize extends SimpleFileVisitor<Path> {
   ...
   *          the max length
   */
  private static final void __printLong(final long l,
      final int maxLength) {
    String s;
    int i;
