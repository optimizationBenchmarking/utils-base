 ...
 * {@link shared.randomization.RandomUtils#longToObject(long, boolean)}
 * instead.
 */
public class DummyCloneableAndSerializable
  ...
  /** create */
  public DummyCloneableAndSerializable() {
    super();
    synchronized (DummyCloneableAndSerializable.RANDOM) {
      DummyCloneableAndSerializable.s_ids += (1
          + DummyCloneableAndSerializable.RANDOM.nextInt(10));
