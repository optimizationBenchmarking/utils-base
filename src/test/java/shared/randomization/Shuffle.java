...
public class Shuffle {
   ...
   * </p>
   * <p>
   * This method therefore applies the
   ...
   *          the random number generator
   */
  private static final void __shuffle(final byte[] array, final int length,
   ...
   *          the random number generator
   */
  private static final void __shuffle(final long[] array, final int length,
      final int start, final int count, final Random random) {
    long temp;
    int index, firstItem, secondItem;
   ...
   *          the random number generator
   */
  private static final void __shuffle(final char[] array, final int length,
      final int start, final int count, final Random random) {
    char temp;
    int index, firstItem, secondItem;
