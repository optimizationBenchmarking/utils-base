...
public class TextUtilsTest extends TestBase {
  ...
  public void testAppendFileSizeSimple() {
    ...
    TextUtils.appendFileSize(((1024L * 1024L * 1024L) - (513 * 1024)),
        mto);
    Assert.assertEquals("1023\u2007MiB", mto.toString()); //$NON-NLS-1$
    mto.clear();

    TextUtils.appendFileSize(((1024L * 1024L * 1024L) - (512 * 1024)),
        mto);
    ...
    TextUtils.appendFileSize(((1024L * 1024L * 1024L * 1024L * 1023L) - 1),
        mto);
