 ...
 */
public class MemoryTextOutputTest
    extends TextOutputTest<MemoryTextOutput> {
    ...
    for (j = 4; (--j) >= 0;) {
      ...
      for (; (--i) >= 0;) {
        switch (rand.nextInt(3)) {
          case 0: {
            sb.append(String.valueOf(RandomUtils
                .longToObject(rand.nextLong(), rand.nextBoolean())));
            break;
          }
          case 1: {
