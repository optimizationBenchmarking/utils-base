...
public class LookupCharTransformerTest extends CharTransformerTest {
  ...
  // t.transform(
  // "ababaaaaabaaaaaaaabccaaaaacaaac", ETransformationMode.HYPHENATED));
  // //$NON-NLS-1$/
  //
  // Assert
  // .assertEquals(
  ...
  // t.transform(
  // "ababaaAaaabaaaaaaaabccaaaaacaaac", ETransformationMode.HYPHENATED));
  // //$NON-NLS-1$/
  //
  // Assert
  // .assertEquals(
  ...
  // t.transform(
  // "ababaa.aaabaaaaaaaabccaaaaacaaac", ETransformationMode.HYPHENATED));
  // //$NON-NLS-1$/
  //
  // Assert
  // .assertEquals(
  // "a a aa.-Aaaa aaaaaaaa ccaaaaacaaac", //$NON-NLS-1$/
  // t.transform(
  // "ababaa.Aaaabaaaaaaaabccaaaaacaaac", ETransformationMode.HYPHENATED));
  // //$NON-NLS-1$/
  //
  // Assert
  // .assertEquals(
  ...
  // t.transform(
  // "ababaa.AAAaaabaaaaaaaabccaaaaacaaac",
  // ETransformationMode.HYPHENATED)); //$NON-NLS-1$/
  // }
